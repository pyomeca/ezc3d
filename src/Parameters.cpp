...
ezC3D::Parameters::Parameters(ezC3D &file) :
    _parametersStart(0),
    _checksum(0),
    _nbParamBlock(0),
    _processorType(0)
...
int ezC3D::Parameters::processorType() const
{
    return _processorType;
}
int ezC3D::Parameters::nbParamBlock() const
{
    return _nbParamBlock;
}
int ezC3D::Parameters::checksum() const
{
    return _checksum;
}
int ezC3D::Parameters::parametersStart() const
{
    return _parametersStart;
}
void ezC3D::Parameters::print() const
{
...
const std::vector<ezC3D::Parameters::Group>& ezC3D::Parameters::groups() const
{
    return _groups;
}
...
int ezC3D::Parameters::Group::read(ezC3D &file, int nbCharInName)
{
    if (nbCharInName < 0)
        _isLocked = true;
    else
...
int ezC3D::Parameters::Group::addParameter(ezC3D &file, int nbCharInName)
{
...
int ezC3D::Parameters::Group::Parameter::read(ezC3D &file, int nbCharInName)
{
    if (nbCharInName < 0)
        _isLocked = true;
    else
